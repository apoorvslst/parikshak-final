        ...
        <nav className="fixed top-0 left-0 w-full flex flex-row bg-transparent justify-between text-white">
          <div className="left flex flex-row">
            <img
              ...
              src="https://yt3.googleusercontent.com/t8z86Svc4diX-k6VHCZ7AY0EFgVin91qLZigPwJLnavVaB0YPa0etWa-c7bG1BUEcbB4U4im=s900-c-k-c0x00ffffff-no-rj"
              alt=""
            />
          ...
          <div className="right flex flex-row justify-around items-center">
            ...
            {isUserLoggedIn ? (
  <img
    src={currentUser?.photoURL}   // <-- Google profile pic
    alt="profile"
    className="mx-10 w-10 h-10 rounded-full border border-white"
  />
) : (
  <button className="mx-10 bg-[#24cfa6] h-9 w-28 rounded" onClick={loginWithGoogle}>
    Sign In
  </button>
)}
          </div>
